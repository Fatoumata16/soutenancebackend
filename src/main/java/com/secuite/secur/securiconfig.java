...
public class securiconfig extends WebSecurityConfigurerAdapter {@Autowired
private servuser s;
...
//                });
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.headers()
                .addHeaderWriter(
                        new StaticHeadersWriter("Access-Control-Allow-Origin", "http://localhost:8100")
                );
        // http.csrf().disable();
        ...
        //a decocher ouiiiiiiiiiiiiiiiiiiiiiiiiii
